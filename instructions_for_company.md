...
Важными аспектами справа, также является следующее:

- Кнопка "Создать Чат" позволяет создать нам пустой чат переписки с ИИ, в котором мы можем тестировать новый чат и общение с ИИ с нуля. Найти ссылку на этот чат можно чуть ниже - в разделе "Демо чаты". Скопируйте ссылку и перейдите на вкладу с ИИ
- В разделе "Инструкции" можно отключить ИИ во всех чатах, например если вы хотите опробовать новый функционал или остановать работу ИИ с клиентами.
